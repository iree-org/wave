...
loop_0_body:
    ...
    s_waitcnt lgkmcnt(0)
    v_mfma_f32_16x16x16_f16 v[4:7], v[26:27], v[20:21], v[4:7]  // MFMA with accumulator (in-place)
    s_waitcnt lgkmcnt(0)
    v_mfma_f32_16x16x16_f16 v[4:7], v[28:29], v[22:23], v[4:7]  // MFMA with accumulator (in-place)
loop_0_latch:
