...
def check_water_install(water_build_path):
    # Validate build directory contains expected artifacts
    water_opt_path = water_build_path / "bin" / "water-opt"
    ...
    python_packages_dir = water_build_path / "python_packages" / "water_mlir"
