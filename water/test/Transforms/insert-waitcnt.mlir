...
// CHECK-LABEL: func.func @raw_dependency_vector_load_redundant_waitcnt
func.func @raw_dependency_vector_load_redundant_waitcnt(%global: memref<64x64xf32>, %lds: memref<64x64xf32, #gpu.address_space<workgroup>>) {
  %c0 = arith.constant 0 : index
  ...
  // This wait is redundant after we insert wait before barrier.
  amdgpu.memory_counter_wait tensor(2)
...
// CHECK-LABEL: func.func @triple_buffer_loop_sync_before
func.func @triple_buffer_loop_sync_before(%global: memref<512x64xf32>, %lds1: memref<64x64xf32, #gpu.address_space<workgroup>>, %lds2: memref<64x64xf32, #gpu.address_space<workgroup>>, %lds3: memref<64x64xf32, #gpu.address_space<workgroup>>) {
  %c0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index
  %c8 = arith.constant 8 : index
  %c64 = arith.constant 64 : index
...
// CHECK-LABEL: func.func @triple_buffer_loop_no_init
func.func @triple_buffer_loop_no_init(%global: memref<512x64xf32>, %lds1: memref<64x64xf32, #gpu.address_space<workgroup>>, %lds2: memref<64x64xf32, #gpu.address_space<workgroup>>, %lds3: memref<64x64xf32, #gpu.address_space<workgroup>>) {
  %c0 = arith.constant 0 : index
  %c1 = arith.constant 1 : index
  %c8 = arith.constant 8 : index
  %c64 = arith.constant 64 : index

  // Triple buffering without intializing the initial buffers
