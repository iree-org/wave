...
// CHECK-SAME: attributes {water.total_registers = 6 : i32}
func.func @test_simple_numbering(%arg0: memref<100xf32>) -> f32 {
  %c0 = arith.constant 0 : index

  // 1xf32 = 4 bytes = 1 register, starts at reg 0
  // CHECK: memref.alloca() {water.register_count = 1 : i32, water.register_number = 0 : i32}
  %reg0 = memref.alloca() : memref<1xf32, 128 : i32>

  // 4xf32 = 16 bytes = 4 registers, starts at reg 1
  // CHECK: memref.alloca() {water.register_count = 4 : i32, water.register_number = 1 : i32}
  %reg1 = memref.alloca() : memref<4xf32, 128 : i32>

  // 1xf32 = 4 bytes = 1 register, starts at reg 5 (after reg1)
  // CHECK: memref.alloca() {water.register_count = 1 : i32, water.register_number = 5 : i32}
...
// CHECK-SAME: attributes {water.total_registers = 1 : i32}
...
// CHECK-SAME: attributes {water.total_registers = 12 : i32}
func.func @test_triple_buffering_numbering(%src: memref<1024xf32>, %lb: index, %ub: index, %step: index, %offset: index) {
  ...
  // CHECK: memref.alloca() {water.register_count = 4 : i32, water.register_number = 0 : i32}
  %reg0 = memref.alloca() : memref<4xf32, 128 : i32>

  // CHECK: memref.alloca() {water.register_count = 4 : i32, water.register_number = 4 : i32}
  %reg1 = memref.alloca() : memref<4xf32, 128 : i32>

  // CHECK: memref.alloca() {water.register_count = 4 : i32, water.register_number = 8 : i32}
...
func.func @test_mixed_memspaces(%arg0: memref<100xf32>) {
  ...
  // CHECK-NOT: water.register_number
