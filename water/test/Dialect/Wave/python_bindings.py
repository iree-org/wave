...
try:
    ...
    with ir.Context() as ctx:
        ...
        expr_attr = wave.WaveExpressionListAttr.get(symbol_names, start_map)
        print(expr_attr)

        try:
            wave.WaveExpressionListAttr.get(symbol_names[:-1], start_map)
        except ValueError as e:
        ...
        try:
            ...
            assert "must be a WaveExpressionListAttr" in str(e)
        else:
            assert False, "Expected to fail with TypeError."
