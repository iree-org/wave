...
// Test that permute result type must be fully-specified
func.func @permute_result_not_fully_specified(%arg0: !wave.tensor<[@M, @N] of f32, <register>>) {
  // expected-error @below {{'wave.permute' op result #0 must be fully-specified wave tensor in register or a 1D vector, but got '!wave.tensor<any of f32, <register>>'}}
  wave.permute %arg0 : !wave.tensor<[@M, @N] of f32, <register>> to !wave.tensor<any of f32, <register>>
  return
}
