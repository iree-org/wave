...
// -----
// Test apply_expr with no operands.
func.func @apply_expr_no_operands() {
  // expected-error @below {{'wave.apply_expr' op requires at least one operand}}
  "wave.apply_expr"() {expr = #wave.expr_list<[] -> (1)>} : () -> !wave.tensor<[@M] of i32>
  return
}
