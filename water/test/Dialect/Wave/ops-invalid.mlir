...
func.func @extract_slice_mismatch_offset_size(%memory: !wave.tensor<[@A, @B] of f16>) {
  ...
  wave.extract_slice %memory {offset = #wave.expr<[] -> (3)>, size = #wave.expr<[] -> (32, 16)>, stride = #wave.expr<[] -> (2)>} : (!wave.tensor<[@A, @B] of f16>) -> !wave.tensor<[@A, @B] of f16>
  return
}
...
func.func @extract_slice_mismatch_offset_stride(%memory: !wave.tensor<[@A, @B] of f16>) {
  ...
  wave.extract_slice %memory {offset = #wave.expr<[] -> (3, 5)>, size = #wave.expr<[] -> (32, 16)>, stride = #wave.expr<[] -> (2)>} : (!wave.tensor<[@A, @B] of f16>) -> !wave.tensor<[@A, @B] of f16>
  return
}
...
func.func @extract_slice_mismatch_size_stride(%memory: !wave.tensor<[@A, @B] of f16>) {
  ...
  wave.extract_slice %memory {offset = #wave.expr<[] -> (3)>, size = #wave.expr<[] -> (32)>, stride = #wave.expr<[] -> (2, 1, 4)>} : (!wave.tensor<[@A, @B] of f16>) -> !wave.tensor<[@A, @B] of f16>
  return
}
...
func.func @extract_slice_with_symbols(%memory: !wave.tensor<[@A, @B] of f16>) {
  ...
  wave.extract_slice %memory {offset = #wave.expr<[BLOCK_M] -> (BLOCK_M)>, size = #wave.expr<[] -> (32)>, stride = #wave.expr<[] -> (2)>} : (!wave.tensor<[@A, @B] of f16>) -> !wave.tensor<[@A, @B] of f16>
  return
}
...
func.func @extract_slice_all_with_symbols(%memory: !wave.tensor<[@A, @B] of f16>) {
  ...
  wave.extract_slice %memory {offset = #wave.expr<[BLOCK_M] -> (BLOCK_M + 2)>, size = #wave.expr<[BLOCK_K] -> (BLOCK_K * 2)>, stride = #wave.expr<[BLOCK_N] -> (BLOCK_N)>} : (!wave.tensor<[@A, @B] of f16>) -> !wave.tensor<[@A, @B] of f16>
  return
}
