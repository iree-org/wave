...
module attributes { wave.normal_form = #wave.normal_form<full_types> } {
  ...
  attributes { wave.constraints = [
    ...
    // CHECK: wave.mma
    // Left-hand side
    // CHECK-DAG:  M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 16, 1, 1)
    // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 16) * 4, 4, 1)
    // CHECK: }, {
    // Right-hand side
    // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 16) * 4, 4, 1)
    // CHECK-DAG:  N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 16, 1, 1)
    // CHECK: }, {
    // Accumulator
    // CHECK-DAG:  M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 16) * 4, 4, 16)
    // CHECK-DAG:  N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 16, 1, 1)
    // CHECK: }, {
...
module attributes { wave.normal_form = #wave.normal_form<full_types> } {
  ...
  attributes { wave.constraints = [
    ...
    // CHECK: wave.read
    // CHECK-DAG: K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 + T2 * 2) mod 64) floordiv 16) * 4, 4, 1)
    // CHECK-DAG: M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 + T2 * 2) mod 16, 1, 1)
    %a_read = wave.read %a
      : (!wave.tensor<[@M, @K] of f16>) -> !wave.tensor<[@M, @K] of f16, <register>>
    // CHECK: wave.read
    // CHECK-DAG: K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 + T2 * 2) mod 64) floordiv 16) * 4, 4, 1)
    // CHECK-DAG: N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 + T2 * 2) mod 16, 1, 1)
    %b_read = wave.read %b
      : (!wave.tensor<[@N, @K] of f16>) -> !wave.tensor<[@N, @K] of f16, <register>>
    %cst_0 = arith.constant 0.0 : f32
    // CHECK: wave.register
    // CHECK-DAG: M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 + T2 * 2) mod 64) floordiv 16) * 4, 4, 16)
    // CHECK-DAG: N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 + T2 * 2) mod 16, 1, 1)
    ...
    // CHECK: wave.read
    // CHECK-DAG: M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 + T2 * 2) mod 16, 1, 1)
    // CHECK-DAG: N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 + T2 * 2) mod 64) floordiv 16) * 4, 4, 1)
    %reloaded = wave.read %storage : (!wave.tensor<[@M, @N] of f16>) -> !wave.tensor<[@M, @N] of f16, <register>>

    // Second read and register
    // CHECK: wave.read
    // CHECK-DAG: N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 + T2 * 2) mod 64) floordiv 16) * 4, 4, 1)
    // CHECK-DAG: P : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 + T2 * 2) mod 16, 1, 1)
    %d_read = wave.read %d
...
module attributes { wave.normal_form = #wave.normal_form<full_types> } {
  ...
  attributes { wave.constraints = [
    ...
    // CHECK: wave.mma
    // CHECK-DAG:  M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 32, 1, 1)
    // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 32) * 4, 4, 1)
    // CHECK: }, {
    // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 32) * 4, 4, 1)
    // CHECK-DAG:  N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 32, 1, 1)
    // CHECK: }, {
    // CHECK-DAG:  M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> (((GPR_NUM floordiv 4) * 8) mod 32 + (((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 32) * 4 + GPR_NUM mod 4, 16, 32)
    // CHECK-DAG:  N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 32, 1, 1)
    // CHECK: }, {
    // CHECK-DAG:  M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> (((GPR_NUM floordiv 4) * 8) mod 32 + (((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 32) * 4 + GPR_NUM mod 4, 16, 32)
    // CHECK-DAG:  N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 32, 1, 1)
...
module attributes { wave.normal_form = #wave.normal_form<full_types> } {
  ...
  attributes { wave.constraints = [
    ...
    // CHECK: wave.mma
    // CHECK-DAG:  M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 16, 1, 1)
    // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 16) * 8, 8, 1)
    // CHECK: }, {
    // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 16) * 8, 8, 1)
    // CHECK-DAG:  N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 16, 1, 1)
    // CHECK: }, {
...
module attributes { wave.normal_form = #wave.normal_form<full_types> } {
  ...
  attributes { wave.constraints = [
    ...
    // CHECK: wave.mma
    // CHECK-DAG:  M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 16, 1, 1)
    // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((GPR_NUM floordiv 4) * 16 + (((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 16) * 4 + GPR_NUM mod 4, 8, 1)
    // CHECK: }, {
    // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((GPR_NUM floordiv 4) * 16 + (((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 16) * 4 + GPR_NUM mod 4, 8, 1)
    // CHECK-DAG:  N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 16, 1, 1)
    // CHECK: }, {
...
module attributes { wave.normal_form = #wave.normal_form<full_types> } {
  ...
  attributes { wave.constraints = [
    ...
    // CHECK: wave.mma
    // CHECK-DAG:  M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 32, 1, 1)
    // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 32) * 8, 8, 1)
    // CHECK: }, {
    // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 32) * 8, 8, 1)
    // CHECK-DAG:  N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 32, 1, 1)
    // CHECK: }, {
...
module attributes { wave.normal_form = #wave.normal_form<full_types> } {
  ...
  attributes { wave.constraints = [
    ...
    // CHECK: wave.mma
    // CHECK-DAG:  M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 32, 1, 1)
    // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((GPR_NUM floordiv 4) * 8 + (((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 32) * 4 + GPR_NUM mod 4, 8, 1)
    // CHECK: }, {
    // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((GPR_NUM floordiv 4) * 8 + (((T0 + T1 * 2 + T2 * 6) mod 64) floordiv 32) * 4 + GPR_NUM mod 4, 8, 1)
    // CHECK-DAG:  N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 * 2 + T2 * 6) mod 32, 1, 1)
    // CHECK: }, {
...
module attributes { wave.normal_form = #wave.normal_form<full_types> } {
  ...
  func.func @iterate(%a: !wave.tensor<[@M, @K] of bf16, <shared>>,
    ...
    // CHECK:      wave.register
    // CHECK-DAG:  M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> (((GPR_NUM floordiv 4) * 8) mod 32 + (((T0 + T1 + T2 * 2) mod 64) floordiv 32) * 4 + GPR_NUM mod 4, 16, 32)
    // CHECK-DAG:  N : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 + T2 * 2) mod 32, 1, 1)
    ...
    %mma_result = wave.iterate @K iter_args(%c_reg) {
      ^bb0(%acc: !wave.tensor<[@M, @N] of f32>):
        ...
        // CHECK:      wave.read
        // CHECK-DAG:  K : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((((T0 + T1 + T2 * 2) mod 64) floordiv 32) * 8, 8, 1)
        // CHECK-DAG:  M : [#wave.index_symbol<T0>, #wave.index_symbol<T1>, #wave.index_symbol<T2>, #wave.index_symbol<GPR_NUM>] -> ((T0 + T1 + T2 * 2) mod 32, 1, 1)
