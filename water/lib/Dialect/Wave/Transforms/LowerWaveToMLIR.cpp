...
struct LowerWaveToMLIRPass
  ...
  void runOnOperation() override {
    ...
    target.addIllegalOp<wave::AddOp, wave::SubOp, wave::AllocateOp,
                        ...
                        wave::Exp2Op, wave::ExtractOp, wave::ExtractSliceOp,
                        wave::IterateOp, wave::MmaOp, wave::MulOp,
                        wave::PermuteOp, wave::ReadOp, wave::RegisterOp,
                        wave::ShuffleOp, wave::WriteOp, wave::YieldOp>();
