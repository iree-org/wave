...
class OperationHandlers:
    ...
    def handle_scf_for_op(self, operation: scf_d.ForOp, kernel_info: KernelInfo):
        ...
        lower_bound = kernel_info.index_env.get(lower_bound_ssa, 0)
        upper_bound = kernel_info.index_env.get(upper_bound_ssa, 16)
        step = kernel_info.index_env.get(step_ssa, 1)
