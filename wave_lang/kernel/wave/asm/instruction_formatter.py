...
def format_operand(
    ...
    if isinstance(value, int):
        ...
        has_reg_type = any(
            t in operand_types
            for t in (OperandType.VGPR, OperandType.SGPR, OperandType.VGPR_PAIR, 
                      OperandType.SGPR_PAIR, OperandType.VGPR_QUAD, OperandType.SGPR_QUAD)
        )
        has_imm_type = OperandType.IMM in operand_types or OperandType.SIMM in operand_types
...
class InstructionFormatter:
    ...
    def format_mov(self, dst: str, src: Any, is_sgpr: bool = False, comment: str = None) -> str:
    ...
    def format_load_dwordx2(self, dst: str, base: str, offset: int, comment: str = None) -> str:
        """Format an s_load_dwordx2 instruction."""
        return self.format("s_load_dwordx2", defs=[dst], uses=[base, offset], comment=comment)
    
    def format_waitcnt(self, vmcnt: int = None, lgkmcnt: int = None, comment: str = None) -> str:
