...
"""
Shared MLIR analysis helpers for the WaveASM backend.

Provides function selection, translation_info parsing, and workgroup-id
detection used by compile.py and waveasm_e2e.py.
"""
...
def extract_translation_info(
    ...
    workgroup_size_tuple = translation_info.workgroup_size
    sg_size = translation_info.subgroup_size
...
def extract_func_from_stream_mlir(mlir_text: str) -> str:
    ...
    """
    from wave_lang.support.ir_imports import Context, Module
