...
/tmp/tmpnzlp3lhd/isolated_benchmark.hsaco:	file format elf64-amdgpu
...
00000000000016a8 <loop_0_header>:
	...
	s_branch loop_0_exit                                       // 0000000016B0: BF82007D
...
00000000000016b4 <loop_0_body>:
	...
	v_lshlrev_b32_e32 v17, 10, v15                             // 00000000174C: 24221E8A
	v_add_u32_e32 v18, v16, v17                                // 000000001750: 68242310
	v_lshlrev_b32_e32 v16, 11, v1                              // 000000001754: 2420028B
	v_add_u32_e32 v19, v18, v16                                // 000000001758: 68262112
	s_nop 0                                                    // 00000000175C: BF800000
	v_readfirstlane_b32 s8, v19                                // 000000001760: 7E100513
	...
	v_add_u32_e32 v8, v17, v16                                 // 00000000178C: 68102111
	v_lshrrev_b32_e32 v11, 1, v1                               // 000000001790: 20160281
	v_lshrrev_b32_e32 v12, 2, v15                              // 000000001794: 20181E82
	v_add_u32_e32 v14, v11, v12                                // 000000001798: 681C190B
	v_and_b32_e32 v11, 0, v14                                  // 00000000179C: 26161C80
	...
	v_add_u32_e32 v14, v12, v16                                // 0000000017E0: 681C210C
	ds_read_b64 v[16:17], v14                                  // 0000000017E4: D8EC0000 1000000E
	ds_read_b64 v[18:19], v14 offset:32                        // 0000000017EC: D8EC0020 1200000E
	ds_read_b64 v[20:21], v14 offset:64                        // 0000000017F4: D8EC0040 1400000E
	ds_read_b64 v[22:23], v14 offset:96                        // 0000000017FC: D8EC0060 1600000E
	v_add_u32_e32 v12, v13, v8                                 // 000000001804: 6818110D
	v_add_u32_e32 v13, v12, v2                                 // 000000001808: 681A050C
	v_lshlrev_b32_e32 v12, 11, v15                             // 00000000180C: 24181E8B
	v_add_u32_e32 v14, v13, v12                                // 000000001810: 681C190D
	ds_read_b64 v[24:25], v14                                  // 000000001814: D8EC0000 1800000E
	v_mov_b32_e32 v13, 0x1020                                  // 00000000181C: 7E1A02FF 00001020
	v_add_u32_e32 v14, v13, v8                                 // 000000001824: 681C110D
	v_add_u32_e32 v13, v14, v2                                 // 000000001828: 681A050E
	v_add_u32_e32 v14, v13, v12                                // 00000000182C: 681C190D
	ds_read_b64 v[26:27], v14                                  // 000000001830: D8EC0000 1A00000E
	v_mov_b32_e32 v13, 0x1040                                  // 000000001838: 7E1A02FF 00001040
	v_add_u32_e32 v14, v13, v8                                 // 000000001840: 681C110D
	v_add_u32_e32 v13, v14, v2                                 // 000000001844: 681A050E
	v_add_u32_e32 v14, v13, v12                                // 000000001848: 681C190D
	ds_read_b64 v[28:29], v14                                  // 00000000184C: D8EC0000 1C00000E
	v_mov_b32_e32 v13, 0x1060                                  // 000000001854: 7E1A02FF 00001060
	v_add_u32_e32 v14, v13, v8                                 // 00000000185C: 681C110D
	v_add_u32_e32 v8, v14, v2                                  // 000000001860: 6810050E
	v_add_u32_e32 v2, v8, v12                                  // 000000001864: 68041908
	ds_read_b64 v[12:13], v2                                   // 000000001868: D8EC0000 0C000002
	s_waitcnt lgkmcnt(0)                                       // 000000001870: BF8CC07F
	v_mfma_f32_16x16x16_f16 v[4:7], v[24:25], v[16:17], v[4:7] // 000000001874: D3CD0004 04122118
	s_waitcnt lgkmcnt(0)                                       // 00000000187C: BF8CC07F
	v_mfma_f32_16x16x16_f16 v[4:7], v[26:27], v[18:19], v[4:7] // 000000001880: D3CD0004 0412251A
	s_waitcnt lgkmcnt(0)                                       // 000000001888: BF8CC07F
	v_mfma_f32_16x16x16_f16 v[4:7], v[28:29], v[20:21], v[4:7] // 00000000188C: D3CD0004 0412291C
	s_waitcnt lgkmcnt(0)                                       // 000000001894: BF8CC07F
	v_mfma_f32_16x16x16_f16 v[4:7], v[12:13], v[22:23], v[4:7] // 000000001898: D3CD0004 04122D0C

00000000000018a0 <loop_0_latch>:
	s_add_u32 s24, s24, s25                                    // 0000000018A0: 80181918
	s_branch loop_0_header                                     // 0000000018A4: BF82FF80

00000000000018a8 <loop_0_exit>:
	v_lshlrev_b32_e32 v2, 6, v1                                // 0000000018A8: 24040286
	v_lshl_add_u32 v1, v11, 2, v2                              // 0000000018AC: D1FD0001 0409050B
	v_lshl_add_u32 v2, v9, 7, v1                               // 0000000018B4: D1FD0002 04050F09
	v_lshl_add_u32 v1, v10, 12, v2                             // 0000000018BC: D1FD0001 0409190A
	v_lshl_add_u32 v2, v15, 14, v1                             // 0000000018C4: D1FD0002 04051D0F
	v_lshl_add_u32 v1, v3, 15, v2                              // 0000000018CC: D1FD0001 04091F03
	s_waitcnt vmcnt(0)                                         // 0000000018D4: BF8C0F70
	buffer_store_dword v4, v1, s[12:15], 0 offen               // 0000000018D8: E0701000 80030401
	s_waitcnt vmcnt(0)                                         // 0000000018E0: BF8C0F70
	buffer_store_dword v5, v1, s[12:15], 0 offen offset:1024   // 0000000018E4: E0701400 80030501
	s_waitcnt vmcnt(0)                                         // 0000000018EC: BF8C0F70
	buffer_store_dword v6, v1, s[12:15], 0 offen offset:2048   // 0000000018F0: E0701800 80030601
	s_waitcnt vmcnt(0)                                         // 0000000018F8: BF8C0F70
	buffer_store_dword v7, v1, s[12:15], 0 offen offset:3072   // 0000000018FC: E0701C00 80030701
