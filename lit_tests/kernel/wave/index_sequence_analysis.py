...
def test_gemm():
    ...
    # CHECK-NEXT: %write_5
    # CHECK-SAME: (%extract_slice, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_1
    # CHECK-SAME: (%get_result_M:0_N:0_K:0, [1], [1], [1])
    # CHECK-NEXT: %write_6
    # CHECK-SAME: (%extract_slice_1, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_2
    # CHECK-SAME: (%get_result_M:0_N:0_K:0, [2], [1], [1])
    # CHECK-NEXT: %write_7
    # CHECK-SAME: (%extract_slice_2, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_3
    # CHECK-SAME: (%get_result_M:0_N:0_K:0, [3], [1], [1])
    # CHECK-NEXT: %write_8
    # CHECK-SAME: (%extract_slice_3, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_4
    # CHECK-SAME: (%get_result_M:0_N:1_K:0, [0], [1], [1])
    # CHECK-NEXT: %write_9
    # CHECK-SAME: (%extract_slice_4, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_5
    # CHECK-SAME: (%get_result_M:0_N:1_K:0, [1], [1], [1])
    # CHECK-NEXT: %write_10
    # CHECK-SAME: (%extract_slice_5, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_6
    # CHECK-SAME: (%get_result_M:0_N:1_K:0, [2], [1], [1])
    # CHECK-NEXT: %write_11
    # CHECK-SAME: (%extract_slice_6, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_7
    # CHECK-SAME: (%get_result_M:0_N:1_K:0, [3], [1], [1])
    # CHECK-NEXT: %write_12
    # CHECK-SAME: (%extract_slice_7, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_8
    # CHECK-SAME: (%get_result_M:1_N:0_K:0, [0], [1], [1])
    # CHECK-NEXT: %write_13
    # CHECK-SAME: (%extract_slice_8, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_9
    # CHECK-SAME: (%get_result_M:1_N:0_K:0, [1], [1], [1])
    # CHECK-NEXT: %write_14
    # CHECK-SAME: (%extract_slice_9, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_10
    # CHECK-SAME: (%get_result_M:1_N:0_K:0, [2], [1], [1])
    # CHECK-NEXT: %write_15
    # CHECK-SAME: (%extract_slice_10, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_11
    # CHECK-SAME: (%get_result_M:1_N:0_K:0, [3], [1], [1])
    # CHECK-NEXT: %write_16
    # CHECK-SAME: (%extract_slice_11, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_12
    # CHECK-SAME: (%get_result_M:1_N:1_K:0, [0], [1], [1])
    # CHECK-NEXT: %write_17
    # CHECK-SAME: (%extract_slice_12, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_13
    # CHECK-SAME: (%get_result_M:1_N:1_K:0, [1], [1], [1])
    # CHECK-NEXT: %write_18
    # CHECK-SAME: (%extract_slice_13, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_14
    # CHECK-SAME: (%get_result_M:1_N:1_K:0, [2], [1], [1])
    # CHECK-NEXT: %write_19
    # CHECK-SAME: (%extract_slice_14, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: extract_slice_15
    # CHECK-SAME: (%get_result_M:1_N:1_K:0, [3], [1], [1])
    # CHECK-NEXT: %write_20
    # CHECK-SAME: (%extract_slice_15, %c, 1, None, (), None, MemoryAccessFlags.NONE, None, None)
    ...
    # CHECK-NEXT: %write_18
    # CHECK-SAME: (%read_37, %allocate_3, 8, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: %read_38
    # CHECK-SAME: (%a, 8, None, (), None, MemoryAccessFlags.NONE, None, None, None)
    # CHECK-NEXT: %write_19
    # CHECK-SAME: (%read_38, %allocate_3, 8, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: %read_39
    # CHECK-SAME: (%b, 8, None, (), None, MemoryAccessFlags.NONE, None, None, None)
    # CHECK-NEXT: %write_20
    # CHECK-SAME: (%read_39, %allocate_2, 8, None, (), None, MemoryAccessFlags.NONE, None, None)
    # CHECK-NEXT: %read_40
    # CHECK-SAME: (%b, 8, None, (), None, MemoryAccessFlags.NONE, None, None, None)
    # CHECK-NEXT: %write_21
    # CHECK-SAME: (%read_40, %allocate_2, 8, None, (), None, MemoryAccessFlags.NONE, None, None)
    ...
    # CHECK-NEXT: placeholder(_name=a
    # CHECK-NEXT: placeholder(_name=allocate_2, _type=Memory[N, K].of(f16))
    # CHECK-NEXT: placeholder(_name=b, _type=Memory[N, K].of(f16))
    # CHECK-NEXT: placeholder(_name=allocate_3, _type=Memory[M, K].of(f16))
    ...
    # CHECK-NEXT: write(register_=read_37, memory=allocate_3, elements_per_thread=8,
    ...
    # CHECK-NEXT: write(register_=read_38, memory=allocate_3, elements_per_thread=8,
    ...
    # CHECK-NEXT: write(register_=read_39, memory=allocate_2, elements_per_thread=8,
    ...
    # CHECK-NEXT: write(register_=read_40, memory=allocate_2, elements_per_thread=8,
    # CHECK-SMAE: index={N: BLOCK_N/2 + Mod(16*$T1 + 32*$T2 + floor($T0/8) + 32, 64), K: 8*(Mod($T0, 8)) : 8 : 1})
    # CHECK-NEXT: read(memory=allocate_2, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_20, write_21], index={N: BLOCK_N/2 + Mod($T0, 16) : 1 : 1, K: 4*floor((Mod($T0, 64))/16) : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_2, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_20, write_21], index={N: BLOCK_N/2 + Mod($T0, 16) : 1 : 1, K: 4*floor((Mod($T0, 64))/16) + 16 : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_2, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_20, write_21], index={N: BLOCK_N/2 + Mod($T0, 16) : 1 : 1, K: 4*floor((Mod($T0, 64))/16) + 32 : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_2, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_20, write_21], index={N: BLOCK_N/2 + Mod($T0, 16) : 1 : 1, K: 4*floor((Mod($T0, 64))/16) + 48 : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_2, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_20, write_21], index={N: BLOCK_N/2 + Mod($T0, 16) + 16 : 1 : 1, K: 4*floor((Mod($T0, 64))/16) : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_2, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_20, write_21], index={N: BLOCK_N/2 + Mod($T0, 16) + 16 : 1 : 1, K: 4*floor((Mod($T0, 64))/16) + 16 : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_2, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_20, write_21], index={N: BLOCK_N/2 + Mod($T0, 16) + 16 : 1 : 1, K: 4*floor((Mod($T0, 64))/16) + 32 : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_2, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_20, write_21], index={N: BLOCK_N/2 + Mod($T0, 16) + 16 : 1 : 1, K: 4*floor((Mod($T0, 64))/16) + 48 : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_3, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_18, write_19], index={M: Mod($T0, 16) : 1 : 1, K: 4*floor((Mod($T0, 64))/16) : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_3, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_18, write_19], index={M: Mod($T0, 16) : 1 : 1, K: 4*floor((Mod($T0, 64))/16) + 16 : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_3, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_18, write_19], index={M: Mod($T0, 16) : 1 : 1, K: 4*floor((Mod($T0, 64))/16) + 32 : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_3, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_18, write_19], index={M: Mod($T0, 16) : 1 : 1, K: 4*floor((Mod($T0, 64))/16) + 48 : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_3, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_18, write_19], index={M: Mod($T0, 16) + 16 : 1 : 1, K: 4*floor((Mod($T0, 64))/16) : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_3, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_18, write_19], index={M: Mod($T0, 16) + 16 : 1 : 1, K: 4*floor((Mod($T0, 64))/16) + 16 : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_3, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_18, write_19], index={M: Mod($T0, 16) + 16 : 1 : 1, K: 4*floor((Mod($T0, 64))/16) + 32 : 4 : 1})
    # CHECK-NEXT: read(memory=allocate_3, elements_per_thread=4, mapping_dynamic_vals=(), flags=MemoryAccessFlags.NONE, _write_dependency=[write_18, write_19], index={M: Mod($T0, 16) + 16 : 1 : 1, K: 4*floor((Mod($T0, 64))/16) + 48 : 4 : 1})
