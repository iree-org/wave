...
def test_read_write_equal_sizes():
    ...
    # CHECK: %allocate
    # CHECK-SAME: ((M, N), (BLOCK_M, BLOCK_N + 4), f16, $SHARED_ADDRESS_SPACE, 4, 0)
    # CHECK-NEXT: %a
    # CHECK-NEXT: %c
    # CHECK-NEXT: %read
    ...
    # CHECK-NEXT: %read_1
    # CHECK-SAME: (%allocate, 4, None, (), None, MemoryAccessFlags.NONE, None, None, [%write_1])
    # CHECK-NEXT: %write
    # CHECK-SAME: (%read_1, %c, 4, None, (), None, MemoryAccessFlags.NONE, None, None)
