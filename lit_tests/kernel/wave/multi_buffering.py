...
def test_gemm_multibuffering():
    ...
    for node in trace.get_root_graph().nodes:
        ...
        # CHECK-NEXT: read(memory=outer_rotating_reg_4,
        # CHECK-NEXT: read(memory=outer_rotating_reg_1,
        # CHECK-NEXT: read(memory=outer_rotating_reg_4,
        # CHECK-NEXT: read(memory=outer_rotating_reg_4,
        # CHECK-NEXT: write(register_=read_21_mapped_2_0,
        # CHECK-NEXT: write(register_=read_22_mapped_2_0,
        # CHECK-NEXT: read(memory=outer_rotating_reg_2,
        # CHECK-NEXT: read(memory=outer_rotating_reg_2,
        # CHECK-NEXT: read(memory=outer_rotating_reg_3,
        # CHECK-NEXT: read(memory=outer_rotating_reg_2,
