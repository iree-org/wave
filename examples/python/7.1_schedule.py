...
def test_dbuf_8wave_pingpong_mxfp_gemm_Bshuffle_lds_transposed(
    ...
    """MXFP4 GEMM with transposed computation for wide stores.
    ...
    The MLIR below is handwritten and contains a custom epilogue that uses
    ...
    mlir_epilogue_opt_256x192x256 = """
        ...
        stream.executable private @gemm {
            ...
            func.func @gemm(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding, %arg3: !stream.binding, %arg4: !stream.binding, %arg5: index, %arg6: index, %arg7: index, %arg8: index, %arg9: index, %arg10: index, %arg11: index, %arg12: index) attributes {translation_info = #translation} {
                ...
                %p466 = arith.truncf %388 : vector<4xf32> to vector<4xbf16>
                %p467 = arith.truncf %390 : vector<4xf32> to vector<4xbf16>
                %p468 = amdgpu.permlane_swap %p466 16 : vector<4xbf16>
                %p469 = amdgpu.permlane_swap %p467 16 : vector<4xbf16>
                %p470 = vector.shuffle %p466, %p468 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p471 = vector.shuffle %p469, %p467 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p472 = arith.select %444, %p470, %p471 : vector<8xbf16>
                %p473 = arith.select %444, %mt0, %mt1 : index
                %p474 = arith.addi %bn0, %p473 overflow<nsw> : index
                vector.store %p472, %442[%p474] : memref<?xbf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xbf16>
                %p475 = arith.truncf %392 : vector<4xf32> to vector<4xbf16>
                %p476 = arith.truncf %394 : vector<4xf32> to vector<4xbf16>
                %p477 = amdgpu.permlane_swap %p475 16 : vector<4xbf16>
                %p478 = amdgpu.permlane_swap %p476 16 : vector<4xbf16>
                %p479 = vector.shuffle %p475, %p477 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p480 = vector.shuffle %p478, %p476 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p481 = arith.select %444, %p479, %p480 : vector<8xbf16>
                %p482 = arith.select %444, %mt2, %mt3 : index
                %p483 = arith.addi %bn0, %p482 overflow<nsw> : index
                vector.store %p481, %442[%p483] : memref<?xbf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xbf16>
                %p484 = arith.truncf %396 : vector<4xf32> to vector<4xbf16>
                %p485 = arith.truncf %398 : vector<4xf32> to vector<4xbf16>
                %p486 = amdgpu.permlane_swap %p484 16 : vector<4xbf16>
                %p487 = amdgpu.permlane_swap %p485 16 : vector<4xbf16>
                %p488 = vector.shuffle %p484, %p486 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p489 = vector.shuffle %p487, %p485 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p490 = arith.select %444, %p488, %p489 : vector<8xbf16>
                %p491 = arith.select %444, %mt4, %mt5 : index
                %p492 = arith.addi %bn0, %p491 overflow<nsw> : index
                vector.store %p490, %442[%p492] : memref<?xbf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xbf16>
                %p493 = arith.truncf %400 : vector<4xf32> to vector<4xbf16>
                %p494 = arith.truncf %402 : vector<4xf32> to vector<4xbf16>
                %p495 = amdgpu.permlane_swap %p493 16 : vector<4xbf16>
                %p496 = amdgpu.permlane_swap %p494 16 : vector<4xbf16>
                %p497 = vector.shuffle %p493, %p495 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p498 = vector.shuffle %p496, %p494 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p499 = arith.select %444, %p497, %p498 : vector<8xbf16>
                %p500 = arith.select %444, %mt6, %mt7 : index
                %p501 = arith.addi %bn0, %p500 overflow<nsw> : index
                vector.store %p499, %442[%p501] : memref<?xbf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xbf16>
                %p502 = arith.truncf %406 : vector<4xf32> to vector<4xbf16>
                %p503 = arith.truncf %408 : vector<4xf32> to vector<4xbf16>
                %p504 = amdgpu.permlane_swap %p502 16 : vector<4xbf16>
                %p505 = amdgpu.permlane_swap %p503 16 : vector<4xbf16>
                %p506 = vector.shuffle %p502, %p504 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p507 = vector.shuffle %p505, %p503 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p508 = arith.select %444, %p506, %p507 : vector<8xbf16>
                %p509 = arith.select %444, %mt0, %mt1 : index
                %p510 = arith.addi %bn1, %p509 overflow<nsw> : index
                vector.store %p508, %442[%p510] : memref<?xbf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xbf16>
                %p511 = arith.truncf %410 : vector<4xf32> to vector<4xbf16>
                %p512 = arith.truncf %412 : vector<4xf32> to vector<4xbf16>
                %p513 = amdgpu.permlane_swap %p511 16 : vector<4xbf16>
                %p514 = amdgpu.permlane_swap %p512 16 : vector<4xbf16>
                %p515 = vector.shuffle %p511, %p513 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p516 = vector.shuffle %p514, %p512 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p517 = arith.select %444, %p515, %p516 : vector<8xbf16>
                %p518 = arith.select %444, %mt2, %mt3 : index
                %p519 = arith.addi %bn1, %p518 overflow<nsw> : index
                vector.store %p517, %442[%p519] : memref<?xbf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xbf16>
                %p520 = arith.truncf %414 : vector<4xf32> to vector<4xbf16>
                %p521 = arith.truncf %416 : vector<4xf32> to vector<4xbf16>
                %p522 = amdgpu.permlane_swap %p520 16 : vector<4xbf16>
                %p523 = amdgpu.permlane_swap %p521 16 : vector<4xbf16>
                %p524 = vector.shuffle %p520, %p522 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p525 = vector.shuffle %p523, %p521 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p526 = arith.select %444, %p524, %p525 : vector<8xbf16>
                %p527 = arith.select %444, %mt4, %mt5 : index
                %p528 = arith.addi %bn1, %p527 overflow<nsw> : index
                vector.store %p526, %442[%p528] : memref<?xbf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xbf16>
                %p529 = arith.truncf %418 : vector<4xf32> to vector<4xbf16>
                %p530 = arith.truncf %420 : vector<4xf32> to vector<4xbf16>
                %p531 = amdgpu.permlane_swap %p529 16 : vector<4xbf16>
                %p532 = amdgpu.permlane_swap %p530 16 : vector<4xbf16>
                %p533 = vector.shuffle %p529, %p531 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p534 = vector.shuffle %p532, %p530 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p535 = arith.select %444, %p533, %p534 : vector<8xbf16>
                %p536 = arith.select %444, %mt6, %mt7 : index
                %p537 = arith.addi %bn1, %p536 overflow<nsw> : index
                vector.store %p535, %442[%p537] : memref<?xbf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xbf16>
                %p538 = arith.truncf %424 : vector<4xf32> to vector<4xbf16>
                %p539 = arith.truncf %426 : vector<4xf32> to vector<4xbf16>
                %p540 = amdgpu.permlane_swap %p538 16 : vector<4xbf16>
                %p541 = amdgpu.permlane_swap %p539 16 : vector<4xbf16>
                %p542 = vector.shuffle %p538, %p540 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p543 = vector.shuffle %p541, %p539 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p544 = arith.select %444, %p542, %p543 : vector<8xbf16>
                %p545 = arith.select %444, %mt0, %mt1 : index
                %p546 = arith.addi %bn2, %p545 overflow<nsw> : index
                vector.store %p544, %442[%p546] : memref<?xbf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xbf16>
                %p547 = arith.truncf %428 : vector<4xf32> to vector<4xbf16>
                %p548 = arith.truncf %430 : vector<4xf32> to vector<4xbf16>
                %p549 = amdgpu.permlane_swap %p547 16 : vector<4xbf16>
                %p550 = amdgpu.permlane_swap %p548 16 : vector<4xbf16>
                %p551 = vector.shuffle %p547, %p549 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p552 = vector.shuffle %p550, %p548 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p553 = arith.select %444, %p551, %p552 : vector<8xbf16>
                %p554 = arith.select %444, %mt2, %mt3 : index
                %p555 = arith.addi %bn2, %p554 overflow<nsw> : index
                vector.store %p553, %442[%p555] : memref<?xbf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xbf16>
                %p556 = arith.truncf %432 : vector<4xf32> to vector<4xbf16>
                %p557 = arith.truncf %434 : vector<4xf32> to vector<4xbf16>
                %p558 = amdgpu.permlane_swap %p556 16 : vector<4xbf16>
                %p559 = amdgpu.permlane_swap %p557 16 : vector<4xbf16>
                %p560 = vector.shuffle %p556, %p558 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p561 = vector.shuffle %p559, %p557 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p562 = arith.select %444, %p560, %p561 : vector<8xbf16>
                %p563 = arith.select %444, %mt4, %mt5 : index
                %p564 = arith.addi %bn2, %p563 overflow<nsw> : index
                vector.store %p562, %442[%p564] : memref<?xbf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xbf16>
                %p565 = arith.truncf %436 : vector<4xf32> to vector<4xbf16>
                %p566 = arith.truncf %438 : vector<4xf32> to vector<4xbf16>
                %p567 = amdgpu.permlane_swap %p565 16 : vector<4xbf16>
                %p568 = amdgpu.permlane_swap %p566 16 : vector<4xbf16>
                %p569 = vector.shuffle %p565, %p567 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p570 = vector.shuffle %p568, %p566 [0, 1, 2, 3, 4, 5, 6, 7] : vector<4xbf16>, vector<4xbf16>
                %p571 = arith.select %444, %p569, %p570 : vector<8xbf16>
                %p572 = arith.select %444, %mt6, %mt7 : index
                %p573 = arith.addi %bn2, %p572 overflow<nsw> : index
                vector.store %p571, %442[%p573] : memref<?xbf16, #amdgpu.address_space<fat_raw_buffer>>, vector<8xbf16>
                return
            }
            }
        }
    ...
    options.linearize_shared_access = True
    options.wave_runtime = True
    options.dump_intermediates = "intermediates_transposed_new"
